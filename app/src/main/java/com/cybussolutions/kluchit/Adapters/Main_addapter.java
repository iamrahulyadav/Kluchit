...
public class Main_addapter extends ArrayAdapter<Main_screen_pojo>
{
    ...
    public Main_addapter(Context context, int resource, ArrayList<Main_screen_pojo> list, Activity activity) {
