 ...
 */
public class EasyVideoPlayer extends FrameLayout implements com.afollestad.materialcamera.IUserMethods, TextureView.SurfaceTextureListener,
    ...
    private final Runnable mUpdateCounters = new Runnable() {
        ...
        public void run() {
            ...
            if (pos > dur) pos = dur;
            mLabelPosition.setText(com.afollestad.materialcamera.Util.getDurationString(pos, false));
            mLabelDuration.setText(com.afollestad.materialcamera.Util.getDurationString(dur - pos, true));
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mThemeColor = a.getColor(R.styleable.EasyVideoPlayer_evp_themeColor,
                        com.afollestad.materialcamera.Util.resolveColor(context, R.attr.colorPrimary));
            ...
            mThemeColor = com.afollestad.materialcamera.Util.resolveColor(context, R.attr.colorPrimary);
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        mLabelPosition.setText(com.afollestad.materialcamera.Util.getDurationString(0, false));
        mLabelDuration.setText(com.afollestad.materialcamera.Util.getDurationString(mediaPlayer.getDuration(), false));
    ...
    protected void onFinishInflate() {
        ...
        ((FrameLayout) mClickFrame).setForeground(com.afollestad.materialcamera.Util.resolveDrawable(getContext(), R.attr.selectableItemBackground));
        ...
        mLabelDuration.setText(com.afollestad.materialcamera.Util.getDurationString(0, true));
    ...
    private void invalidateThemeColors() {
        final int labelColor = com.afollestad.materialcamera.Util.isColorDark(mThemeColor) ? Color.WHITE : Color.BLACK;
        mControlsFrame.setBackgroundColor(com.afollestad.materialcamera.Util.adjustAlpha(mThemeColor, 0.85f));
